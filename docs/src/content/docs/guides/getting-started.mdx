...
- **Globe button**: Switch the interface language (currently English and Brazilian Portuguese are supported)
- **A/+/− buttons**: Adjust the font size
- **Gear button**: Access settings, themes, and the export report option
